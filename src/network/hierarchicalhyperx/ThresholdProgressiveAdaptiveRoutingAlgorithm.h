 ...
 */
#ifndef NETWORK_HIERARCHICALHYPERX_THRESHOLDPROGRESSIVEADAPTIVEROUTINGALGORITHM_H_
#define NETWORK_HIERARCHICALHYPERX_THRESHOLDPROGRESSIVEADAPTIVEROUTINGALGORITHM_H_
...
class ThresholdProgressiveAdaptiveRoutingAlgorithm
 ...
 public:
  ThresholdProgressiveAdaptiveRoutingAlgorithm(const std::string& _name,
...
#endif  // NETWORK_HIERARCHICALHYPERX_THRESHOLDPROGRESSIVEADAPTIVEROUTINGALGORITHM_H_
