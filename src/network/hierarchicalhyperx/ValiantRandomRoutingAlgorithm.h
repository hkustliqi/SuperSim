 ...
 */
#ifndef NETWORK_HIERARCHICALHYPERX_VALIANTRANDOMROUTINGALGORITHM_H_
#define NETWORK_HIERARCHICALHYPERX_VALIANTRANDOMROUTINGALGORITHM_H_
...
class ValiantRandomRoutingAlgorithm :
    public GlobalAndLocalRandomRoutingAlgorithm {
 public:
  ValiantRandomRoutingAlgorithm(const std::string& _name,
...
#endif  // NETWORK_HIERARCHICALHYPERX_VALIANTRANDOMROUTINGALGORITHM_H_
